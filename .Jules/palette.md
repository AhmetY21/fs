...
## 2025-02-14 - [Accessible Navigation State]
**Learning:** Visual "active" states on navigation links (like bold text or colors) are invisible to screen reader users, leaving them unsure of their current location.
**Action:** Always add `aria-current="page"` to the link corresponding to the current URL. This provides a programmatic indication of the active page that assistive technologies announce.
