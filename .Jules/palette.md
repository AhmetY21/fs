...
## 2025-02-14 - [Clipboard Interaction Feedback]
**Learning:** Native clipboard actions (like copying a prompt) lack visual feedback by default, leaving users uncertain if the action succeeded.
**Action:** Always wrap clipboard interactions in a stateful component that provides immediate, temporary visual confirmation (e.g., "Copied!") and includes an `aria-live="polite"` region to announce the success to screen readers.
