...
export default function ImageUploader({ onImageSelected, disabled }) {
    ...
    const processFile = useCallback((file) => {
        ...
        // Pass File object directly instead of reading as base64
        // This avoids blocking the main thread and reduces memory usage
        onImageSelected({ file, dataUrl: objectUrl });
    }, [onImageSelected]);
