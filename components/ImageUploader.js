...
export default function ImageUploader({ onImageSelected, disabled }) {
    ...
    const processFile = useCallback((file) => {
        ...
        // Pass the raw File object and objectUrl to keep DOM lightweight
        // This avoids blocking the main thread with Base64 conversion
        onImageSelected({ file, mimeType: file.type, dataUrl: objectUrl });
    }, [onImageSelected]);
