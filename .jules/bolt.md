...
## 2025-05-05 - Cache Static API Route Data
**Learning:** In Next.js/Node API routes, building large static strings via complex array mappings inside the request handler function redundantly wastes CPU cycles on every request.
