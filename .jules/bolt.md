...
## 2025-02-18 - System Prompt Optimization
**Learning:** Pre-calculating expensive or static string generations at the module level when exporting factory or getter functions avoids redundant runtime overhead across invocations.
**Action:** Always pre-calculate static string configurations at the module load time when they depend only on static files or arrays.
