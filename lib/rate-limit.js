...
export function rateLimiter(ip, limit = 10, windowMs = 60000) {
  ...
  // Optimization: Only run cleanup if map is large AND enough time has passed.
  // Previously this ran on every request once size > 1000, causing O(N) performance degradation.
