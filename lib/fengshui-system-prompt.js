 ...
 */
let cachedAnalysisSystemPrompt = null;

export function buildAnalysisSystemPrompt() {
    if (cachedAnalysisSystemPrompt) return cachedAnalysisSystemPrompt;
    ...
    cachedAnalysisSystemPrompt = `You are an expert Feng Shui consultant with deep knowledge of both Form School and Compass School Feng Shui. You are analyzing a room photograph to provide a professional Feng Shui assessment.
...
5. Always check the Command Position first — it is the most important principle.`;
    ...
    return cachedAnalysisSystemPrompt;
}
