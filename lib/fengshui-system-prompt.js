...
/**
 * Module-level cache for the generated system prompt.
 * ⚡ Bolt: Caching this prevents redundant array mapping and large string concatenation on every API request.
 */
...
export function buildAnalysisSystemPrompt() {
    if (!CACHED_SYSTEM_PROMPT) {
        ...
        CACHED_SYSTEM_PROMPT = `You are an expert Feng Shui consultant with deep knowledge of both Form School and Compass School Feng Shui. You are analyzing a room photograph to provide a professional Feng Shui assessment.
