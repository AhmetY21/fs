...
// ⚡ Bolt: Cache the static system prompt to prevent redundant array mapping
// and string concatenation on every API request.
...
export function buildAnalysisSystemPrompt() {
    ...
    cachedPrompt = `You are an expert Feng Shui consultant with deep knowledge of both Form School and Compass School Feng Shui. You are analyzing a room photograph to provide a professional Feng Shui assessment.
