import { FENG_SHUI_RULES, FIVE_ELEMENTS } from './fengshui-rules.js';

// Pre-calculate the knowledge base and final prompt string at module load time
// to avoid redundant runtime string concatenation and array mapping overhead.
