...
// Pre-calculate expensive string operations at module load time
// to avoid O(N) redundant mapping and string concatenations on every API call.
...
const cachedSystemPrompt = `You are an expert Feng Shui consultant with deep knowledge of both Form School and Compass School Feng Shui. You are analyzing a room photograph to provide a professional Feng Shui assessment.
