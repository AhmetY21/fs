...
// ⚡ Bolt Optimization: Cache the compiled system prompt string in a module-level constant
// This prevents redundant array iterations (.map, .join) and string concatenations on every API request.
