...
// ⚡ Bolt: Cache generated prompt to avoid redundant array mappings and string concatenations on every API call.
...
export function buildAnalysisSystemPrompt() {
    ...
    cachedSystemPrompt = `You are an expert Feng Shui consultant with deep knowledge of both Form School and Compass School Feng Shui. You are analyzing a room photograph to provide a professional Feng Shui assessment.
